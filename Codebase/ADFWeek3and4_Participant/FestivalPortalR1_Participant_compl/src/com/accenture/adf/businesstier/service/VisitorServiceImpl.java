...
public class VisitorServiceImpl implements VisitorFacade {
	...
	public ArrayList<Event> showRegisteredEvents(Visitor visitor) {
		...
		try {
			showAllEvents=visitorDAO.registeredEvents(visitor);
		} catch (ClassNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (SQLException e) {
		...
		return showAllEvents; // TODO Replace "null" with "ArrayList<Event>" collection, based on updates to code in the TODO section.
	}
