...
public class TestVisitorController {
	...
	public void testNewVisitor_Negative() {
		...
		try{
			...
			System.out.println("FERSGenericException was thrown");
		}catch(Exception e){
			e.printStackTrace();
		}
	...
	public void testSearchVisitor_Positive() {
		 ...
		 */
		MockHttpServletRequest req=new MockHttpServletRequest("GET","/searchVisitor.htm");
		req.setAttribute("USERNAME", "npatel");
		req.setAttribute("PASSWORD", "password");
		
		try {
			modelAndView = controller.searchVisitor(req, response);
		} catch(FERSGenericException e){
	...
	public void testSearchVisitor_Negative_InvalidUser() {
		 ...
		 */		
		MockHttpServletRequest req=new MockHttpServletRequest("GET","/searchVisitor.htm");
		req.setAttribute("USERNAME", "rohan");
		req.setAttribute("PASSWORD", "password");
		...
		assertEquals(modelAndView.getViewName(),"/index.jsp");
	}
